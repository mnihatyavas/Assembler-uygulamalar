; asmtutor34.asm: SYS_SOCKETCALL ile yaratýlan, baðlanan, dinleyen, kabuleden, okuyan soketin yazmasý örneði.
;
; "https://www.jdoodle.com/compile-assembler-nasm-online/"
;----------------------------------------------------------------------------------------------------------------------------------
; ===34.Yaratýlýp, Baðlanan, Dinleyen, Kabuleden, Okuyan Soketin Yazmasý===
; Gelen soket baðlantýsý kabuledildiðinde bunun DTN dosya tasvir no'sunu kullanarak yanýt yazabiliriz.
; EDX yanýt uzunluðunu, ECX yanýt dizgesini, EBX ESI'deki DTN'yu, EAX=4=sys_write içermeidir.
;----------------------------------------------------------------------------------------------------------------------------------
