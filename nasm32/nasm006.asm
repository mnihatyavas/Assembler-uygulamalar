...
_main:
    ...
    mov [sayaç], ecx		; sayaç deðerini deðiþkene taþý
...
ortala:			; sayaç sýfýrlanmýþsa, toplanacak argüman kalmamýþtýr
    fild dword [toplam]		; toplam'ý al
    fild dword [sayaç]		; sayaç'ý al
...
; nasm006 12 34 56 -7
; Ortalama=26.0000000000000000
; nasm006 12 34 56 -7 3
; Ortalama=21.399999999999999