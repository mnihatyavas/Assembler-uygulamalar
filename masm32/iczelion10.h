/* iczelion10.h: RC dosyalarýnda kullanýlacak sabitlerin topluca tanýmlarý yapýlmýþtýr.
    NOT: Dosya sonunda fazladan boþ satýr býrakýlmazsa, dosyasonu hatasý veriyor. */
