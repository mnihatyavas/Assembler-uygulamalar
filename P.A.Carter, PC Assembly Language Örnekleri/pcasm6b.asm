; pcasm6b.asm: Girilen azami 100 ondalýk sayýyý, altalta dökümleme örneði.
;
; nasm -fwin32 pcasm6b.asm 
; gcc -m32 pcasm6b.obj pcasm6b.c
;----------------------------------------------------------------------------------------------------------------

; Bu altprogram stdin dosyasýndaki duble verileri okur
